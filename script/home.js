...
// document.getElementById('addmoney-btn').addEventListener('click', function (event) {
//     event.preventDefault;
//     // const number1= getInputField1();
//     // console.log(number1)
//     const getAddAmount = getInputField('amount');
//     const cashOutAmount = getInputField('cash-out-amount')
//     console.log( typeof getAddAmount, cashOutAmount)
// })